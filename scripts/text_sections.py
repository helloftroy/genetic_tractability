...
def sentences_for_paper(abstract: str, jats_xml: str | None) -> tuple[list[tuple[str, int, str]], str]:
    """Prefer full text when available; fall back to the abstract.
    Returns (sentences, source) where source is 'fulltext' or 'abstract'."""
    if jats_xml:
